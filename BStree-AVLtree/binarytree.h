...
class BinaryTree{
	...
	public:
        ...
        //set
        void setRoot(BinaryTreeNode<T>* newRoot){root=newRoot;}
        ...
        bool isBSTree(BinaryTreeNode<T>* p)
        {
            ...
            if (p->left) {
                leftChild=p->left;
                if (leftChild->data <= p->data)
                {
                    l=isBSTree(leftChild);
                }
                else return false;
            }
            if (p->right) {
                rightChild = p->right;
                if (rightChild->data >= p->data)
                {
                    r=isBSTree(rightChild);
                }
                else return false;
            }
            return l&&r;
